...
export const deployDexSmartT4CLOracle = async (
...
const deployV1: DeployFunction = async (
  ...
  let contractPath = "contracts/oracle/oracles/dex/dexSmartT4CLOracle.sol:DexSmartT4CLOracle";
  if (isL2) {
    constructorArgs = [...constructorArgs, L2_SEQUENCER_UPTIME_FEED(hre.network.name)];
    contractPath = "contracts/oracle/oraclesL2/dex/dexSmartT4CLOracleL2.sol:DexSmartT4CLOracleL2";
  }
