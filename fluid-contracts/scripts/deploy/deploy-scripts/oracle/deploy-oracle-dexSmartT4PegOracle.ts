...
export const deployDexSmartT4PegOracle = async (
...
const deployV1: DeployFunction = async (
  ...
  let contractPath = "contracts/oracle/oracles/dex/dexSmartT4PegOracle.sol:DexSmartT4PegOracle";
  if (isL2) {
    constructorArgs = [...constructorArgs, L2_SEQUENCER_UPTIME_FEED(hre.network.name)];
    contractPath = "contracts/oracle/oraclesL2/dex/dexSmartT4PegOracleL2.sol:DexSmartT4PegOracleL2";
  }
