...
export const deployOracleGenericOracle = async (
...
const deployV1: DeployFunction = async (
  ...
  let contractPath = "contracts/oracle/oracles/genericOracle.sol:FluidGenericOracle";
  if (isL2) {
    constructorArgs = [...constructorArgs, L2_SEQUENCER_UPTIME_FEED(hre.network.name)];
    contractPath = "contracts/oracle/oraclesL2/genericOracleL2.sol:FluidGenericOracleL2";
  }
