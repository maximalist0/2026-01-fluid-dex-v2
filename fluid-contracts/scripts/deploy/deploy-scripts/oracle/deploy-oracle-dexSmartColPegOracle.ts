...
export const deployDexSmartColPegOracle = async (
...
const deployV1: DeployFunction = async (
  ...
  let contractPath = "contracts/oracle/oracles/dex/dexSmartColPegOracle.sol:DexSmartColPegOracle";
  if (isL2) {
    constructorArgs = [...constructorArgs, L2_SEQUENCER_UPTIME_FEED(hre.network.name)];
    contractPath = "contracts/oracle/oraclesL2/dex/dexSmartColPegOracleL2.sol:DexSmartColPegOracleL2";
  }
