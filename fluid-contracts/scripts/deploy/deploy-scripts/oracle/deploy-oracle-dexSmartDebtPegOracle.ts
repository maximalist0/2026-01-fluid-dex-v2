...
export const deployDexSmartDebtPegOracle = async (
...
const deployV1: DeployFunction = async (
  ...
  let contractPath = "contracts/oracle/oracles/dex/dexSmartDebtPegOracle.sol:DexSmartDebtPegOracle";
  if (isL2) {
    constructorArgs = [...constructorArgs, L2_SEQUENCER_UPTIME_FEED(hre.network.name)];
    contractPath = "contracts/oracle/oraclesL2/dex/dexSmartDebtPegOracleL2.sol:DexSmartDebtPegOracleL2";
  }
