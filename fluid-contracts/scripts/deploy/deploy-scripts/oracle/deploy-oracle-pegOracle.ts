...
export const deployOraclePegOracle = async (
...
const deployV1: DeployFunction = async (
  ...
  let contractPath = "contracts/oracle/oracles/pegOracle.sol:PegOracle";
  if (isL2) {
    constructorArgs = [...constructorArgs, L2_SEQUENCER_UPTIME_FEED(hre.network.name)];
    contractPath = "contracts/oracle/oraclesL2/pegOracleL2.sol:PegOracleL2";
  }
