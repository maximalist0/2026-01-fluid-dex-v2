...
export const deployVaultT1Admin = async (hre: HardhatRuntimeEnvironment, version: FluidVersion) => {
...
const deployV1: DeployFunction = async (hre: HardhatRuntimeEnvironment, version: FluidVersion) => {
  const deployedAddress = await deploy(
    hre,
    "VaultT1Admin",
    "contracts/protocols/vault/vaultT1/adminModule/main.sol:FluidVaultT1Admin",
    version,
    []
  );
  return deployedAddress;
