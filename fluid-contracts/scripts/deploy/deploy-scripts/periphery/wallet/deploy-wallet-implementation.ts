...
export const deployWalletImplementation = async (hre: HardhatRuntimeEnvironment, version: FluidVersion) => {
...
const deployV1: DeployFunction = async (hre: HardhatRuntimeEnvironment, version: FluidVersion) => {
  ...
  const deployedAddress = await deploy(
    ...
    "contracts/periphery/wallet/wallet/main.sol:FluidWalletImplementation",
    version,
