...
// https://data.chain.link/feeds/arbitrum/mainnet/syrupusdc-usdc-exchange-rate
const RATE_SOURCE = "0xF8722c901675C4F2F7824E256B8A6477b2c105FB";

export const CAPPED_RATES_PARAMS_ARBITRUM_SYRUPUSDC: {
