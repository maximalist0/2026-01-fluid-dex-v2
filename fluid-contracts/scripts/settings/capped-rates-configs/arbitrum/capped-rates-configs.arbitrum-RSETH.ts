...
// Chainlink RSETH-ETH Exchange Rate
// https://data.chain.link/feeds/arbitrum/mainnet/rseth-eth-exchange-rate
const RATE_SOURCE = "0x3A917e6B5732dFCc4A45257e3930979fAE6a3737";

export const CAPPED_RATES_PARAMS_ARBITRUM_RSETH: {
