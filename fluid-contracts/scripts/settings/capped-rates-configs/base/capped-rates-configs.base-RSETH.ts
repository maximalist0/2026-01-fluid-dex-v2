...
// https://data.chain.link/feeds/base/mainnet/rseth-eth-exchange-rate
const RATE_SOURCE = "0x99DAf760d2CFB770cc17e883dF45454FE421616b";

export const CAPPED_RATES_PARAMS_BASE_RSETH: {
