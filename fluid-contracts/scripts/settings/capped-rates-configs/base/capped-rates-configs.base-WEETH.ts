...
// Chainlink weETH / eETH Exchange Rate
// https://data.chain.link/feeds/base/base/weeth-eeth-exchange-rate
const RATE_SOURCE = "0x35e9D7001819Ea3B39Da906aE6b06A62cfe2c181";

export const CAPPED_RATES_PARAMS_BASE_WEETH: {
