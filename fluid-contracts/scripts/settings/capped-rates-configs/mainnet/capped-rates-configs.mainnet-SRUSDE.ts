...
// https://etherscan.io/address/0x3d7d6fdf07EE548B939A80edbc9B2256d0cdc003 SRUSDE
const RATE_SOURCE = "0x3d7d6fdf07EE548B939A80edbc9B2256d0cdc003";

export const CAPPED_RATES_PARAMS_MAINNET_SRUSDE: {
  ...
  params: {
    ...
    maxAPRPercent: 60 * 1e4, // 1e4 = 1%
    maxDownFromMaxReachedPercentDebt: 3 * 1e4, // 1e4 = 1%
