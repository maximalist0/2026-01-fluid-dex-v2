...
// https://etherscan.io/token/0x356B8d89c1e1239Cbbb9dE4815c39A1474d5BA7D#readContract SYRUPUSDT
const RATE_SOURCE = "0x356B8d89c1e1239Cbbb9dE4815c39A1474d5BA7D";

export const CAPPED_RATES_PARAMS_MAINNET_SYRUPUSDT: {
  params: FluidCappedRateBase.CappedRateConstructorParamsStruct;
  tokenSymbol: string;
  fullyQualifiedName: string;
} = {
  tokenSymbol: "SYRUPUSDT",
  fullyQualifiedName: CappedRatesConfigsUtils.ERC4626.fullyQualifiedName,
  params: {
    infoName: "USDC per 1 SYRUPUSDT",
