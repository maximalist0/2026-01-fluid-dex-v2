...
// https://etherscan.io/address/0xaE2364579D6cB4Bbd6695846C1D595cA9AF3574d
// from docs https://docs.resolv.xyz/litepaper/for-developers/smart-contracts
const RATE_SOURCE = "0xaE2364579D6cB4Bbd6695846C1D595cA9AF3574d";

export const CAPPED_RATES_PARAMS_MAINNET_RLP: {
  params: FluidCappedRateBase.CappedRateConstructorParamsStruct;
  tokenSymbol: string;
  fullyQualifiedName: string;
} = {
  tokenSymbol: "RLP",
  fullyQualifiedName: "contracts/oracle/cappedRates/rlpCappedRate.sol:FluidRLPCappedRate",
  params: {
