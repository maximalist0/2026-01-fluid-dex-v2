...
// https://etherscan.io/address/0xC58D044404d8B14e953C115E67823784dEA53d8F JRUSDE
const RATE_SOURCE = "0xC58D044404d8B14e953C115E67823784dEA53d8F";

export const CAPPED_RATES_PARAMS_MAINNET_JRUSDE: {
  ...
  params: {
    ...
    maxAPRPercent: 180 * 1e4, // 1e4 = 1%
    maxDownFromMaxReachedPercentDebt: 6 * 1e4, // 1e4 = 1%
