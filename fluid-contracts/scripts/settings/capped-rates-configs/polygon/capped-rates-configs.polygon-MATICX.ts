...
// https://polygonscan.com/address/0xfd225c9e6601c9d38d8f98d8731bf59efcf8c0e3#readProxyContract convertMaticXToMatic method
// directly confirmed by Stader team via TG
const RATE_SOURCE = "0xfd225c9e6601c9d38d8f98d8731bf59efcf8c0e3";

export const CAPPED_RATES_PARAMS_POLYGON_MATICX: {
  params: FluidCappedRateBase.CappedRateConstructorParamsStruct;
  tokenSymbol: string;
  fullyQualifiedName: string;
} = {
  tokenSymbol: "MATICX",
  fullyQualifiedName: "contracts/oracle/cappedRates/maticXCappedRate.sol:FluidMaticXCappedRate",
  params: {
    infoName: "MATIC per 1 MATICX",
    rateSource: RATE_SOURCE,
    rateMultiplier: 1, // multiplier to get returned rate from rateSource to 1e27 precision
    maxAPRPercent: 50 * 1e4, // 1e4 = 1%
