...
const RATE_SOURCE = "0xed7051d55eeaF85E36053D6b0f2C51E59625B047";
// Chainlink feed, confirmed via TG that this is more reliable than the own operated RateProvider
// https://polygonscan.com/address/0xed7051d55eeaF85E36053D6b0f2C51E59625B047

export const CAPPED_RATES_PARAMS_POLYGON_TRUMATIC: {
  params: FluidCappedRateBase.CappedRateConstructorParamsStruct;
  tokenSymbol: string;
  fullyQualifiedName: string;
} = {
  tokenSymbol: "TRUMATIC",
  fullyQualifiedName: CappedRatesConfigsUtils.Chainlink.fullyQualifiedName,
  params: {
    infoName: "MATIC per 1 TRUMATIC",
