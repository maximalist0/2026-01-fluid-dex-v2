...
const SUPPLY_TOKEN = TOKENS_PLASMA.DEX_WSTUSR_USDT.address;
const SUPPLY_DECIMALS = TOKENS_PLASMA.DEX_WSTUSR_USDT.decimals; // count of decimals
...
const ORACLE_CONFIG: DexSmartColPegOracleConfig = {
  oracleName: "DexSmartColPegOracle_WSTUSR-USDT_USDT",
  contractName: "DexSmartColPegOracle",
  params: {
    dexPool: SUPPLY_TOKEN,
    quoteInToken0: false, // quote in USDT
    targetDecimals: 15,
    infoName: "USDT per 1 WSTUSR/USDT colShare",
...
const VAULT_BORROW_CONFIG = (vault: string): AdminModuleStructs.UserBorrowConfigStruct => ({
  ...
  maxDebtCeiling: BORROW_DECIMALS_MULTIPLIER.mul(8_000_000), // 8M USD
  expandDuration: 60 * 60 * 6, // 6hrs in seconds.
