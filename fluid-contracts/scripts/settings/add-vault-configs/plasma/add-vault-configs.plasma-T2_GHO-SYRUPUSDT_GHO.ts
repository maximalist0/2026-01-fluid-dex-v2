...
const SUPPLY_TOKEN = TOKENS_PLASMA.DEX_GHO_SYRUPUSDT.address;
const SUPPLY_DECIMALS = TOKENS_PLASMA.DEX_GHO_SYRUPUSDT.decimals; // count of decimals
...
const ORACLE_CONFIG: DexSmartColPegOracleConfig = {
  oracleName: "DexSmartColPegOracle_GHO-SYRUPUSDT_GHO",
  contractName: "DexSmartColPegOracle",
  params: {
    dexPool: SUPPLY_TOKEN,
    quoteInToken0: false, // quote in GHO
    targetDecimals: 27,
    infoName: "GHO per 1 GHO/SYRUPUSDT colSh.",
