...
const SUPPLY_TOKEN = TOKENS_PLASMA.DEX_USDE_GHO.address;
const SUPPLY_DECIMALS = TOKENS_PLASMA.DEX_USDE_GHO.decimals; // count of decimals
...
const VAULT_CORE_SETTINGS: VaultT2CoreSettings = {
  ...
  collateralFactor: 94 * PERCENT_PRECISION,
  liquidationThreshold: 96 * PERCENT_PRECISION,
