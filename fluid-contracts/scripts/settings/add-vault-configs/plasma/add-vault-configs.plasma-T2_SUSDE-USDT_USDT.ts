...
const SUPPLY_TOKEN = TOKENS_PLASMA.DEX_SUSDE_USDT.address;
const SUPPLY_DECIMALS = TOKENS_PLASMA.DEX_SUSDE_USDT.decimals; // count of decimals
...
const ORACLE_CONFIG: DexSmartColPegOracleConfig = {
  ...
  params: {
    ...
    reservesConversionParams: {
      reservesConversionOracle: ORACLES_PLASMA.SUSDE_USDE_CAPPED,
...
const VAULT_BORROW_CONFIG = (vault: string): AdminModuleStructs.UserBorrowConfigStruct => ({
  ...
  maxDebtCeiling: BORROW_DECIMALS_MULTIPLIER.mul(10_000_000), // 10M USD
  expandDuration: 60 * 60 * 6, // 6hrs in seconds.
