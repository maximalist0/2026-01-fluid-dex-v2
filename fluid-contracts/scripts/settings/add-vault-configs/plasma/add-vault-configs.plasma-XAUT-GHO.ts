...
const VAULT_QUEUE_COUNTER = 0; // id 27
...
const ORACLE_CONFIG: GenericOracleConfig = {
  oracleName: "GenericOracle_XAUT_GHO",
  contractName: "FluidGenericOracle",
  infoName: "GHO per 1 XAUT",
  targetDecimals: 39,
  sources: [
    {
      ...
      invertRate: false,
      multiplier: BigNumber.from(10).pow(31), // scale XAUT to e27 (+21), adjust USD to GHO (+10)
      divisor: 1,
    },
  ],
};
