...
const VAULT_QUEUE_COUNTER = 0; // id 29

const VAULTTYPE = VAULT_TYPE.T2_SMART_COL;

const SUPPLY_TOKEN = TOKENS_PLASMA.DEX_SUSDE_GHO.address;
const SUPPLY_DECIMALS = TOKENS_PLASMA.DEX_SUSDE_GHO.decimals; // count of decimals
