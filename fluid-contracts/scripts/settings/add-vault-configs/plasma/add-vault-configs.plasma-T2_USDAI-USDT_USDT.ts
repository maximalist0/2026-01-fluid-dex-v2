...
const SUPPLY_TOKEN = TOKENS_PLASMA.DEX_USDAI_USDT.address;
const SUPPLY_DECIMALS = TOKENS_PLASMA.DEX_USDAI_USDT.decimals; // count of decimals
...
const ORACLE_CONFIG: DexSmartColPegOracleConfig = {
  oracleName: "DexSmartColPegOracle_USDAI-USDT_USDT",
  contractName: "DexSmartColPegOracle",
  params: {
    dexPool: SUPPLY_TOKEN,
    quoteInToken0: false, // quote in USDT
    targetDecimals: 15,
    infoName: "USDT per 1 USDAI/USDT colShare",
