...
const VAULT_QUEUE_COUNTER = 0; // id 28
...
const ORACLE_CONFIG: GenericOracleConfig = {
  oracleName: "GenericOracle_XPL_GHO",
  contractName: "FluidGenericOracle",
  infoName: "GHO per 1 XPL",
  targetDecimals: 27,
  sources: [
    {
      ...
      invertRate: false,
      multiplier: BigNumber.from(10).pow(19), // scale XPL to e27 (+9), adjust USD to GHO (+10)
      divisor: 1,
    },
  ],
};
...
const VAULT_SUPPLY_CONFIG = (vault: string): AdminModuleStructs.UserSupplyConfigStruct => ({
  baseWithdrawalLimit: SUPPLY_DECIMALS_MULTIPLIER.mul(15_000),
