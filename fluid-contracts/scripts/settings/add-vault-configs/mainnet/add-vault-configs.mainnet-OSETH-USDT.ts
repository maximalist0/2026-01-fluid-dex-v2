...
const VAULT_QUEUE_COUNTER = 1; // id 154
...
const ORACLE_CONFIG: GenericOracleConfig = {
  oracleName: "GenericOracle_OSETH_USDT",
  contractName: "FluidGenericOracle",
  infoName: "USDT per 1 OSETH",
  targetDecimals: 15,
  sources: [
    {
    ...
    },
    {
      ...
      invertRate: false,
      multiplier: BigNumber.from(10).pow(7), // scale ETH to e27 (+9), adjust USD to USDT (-2)
      divisor: 1,
    },
  ],
};
