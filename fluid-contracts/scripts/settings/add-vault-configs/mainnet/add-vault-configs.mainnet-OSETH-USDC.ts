...
const VAULT_QUEUE_COUNTER = 0; // id 153
...
const ORACLE_CONFIG: GenericOracleConfig = {
  oracleName: "GenericOracle_OSETH_USDC",
  contractName: "FluidGenericOracle",
  infoName: "USDC per 1 OSETH",
  targetDecimals: 15,
  sources: [
    {
    ...
    },
    {
      ...
      invertRate: false,
      multiplier: BigNumber.from(10).pow(7), // scale ETH to e27 (+9), adjust USD to USDC (-2)
      divisor: 1,
    },
  ],
};
