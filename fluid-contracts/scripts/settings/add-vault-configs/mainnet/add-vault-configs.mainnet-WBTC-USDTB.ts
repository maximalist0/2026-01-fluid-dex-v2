...
const VAULT_QUEUE_COUNTER = 3; // #131
...
const ORACLE_CONFIG: GenericOracleConfig = {
  oracleName: "GenericOracle_WBTC_USDTB",
  contractName: "FluidGenericOracle",
  infoName: "USDTB per 1 WBTC",
  sources: [
    {
      ...
      invertRate: false,
      multiplier: BigNumber.from(10).pow(29), // scale WBTC to e27 (+19), adjust USD to USDTB (+10)
      divisor: 1,
    },
  ],
  targetDecimals: 37, // scale WBTC 8 to 27 + USDTB
};
