...
const VAULT_QUEUE_COUNTER = 1; // id 108
...
const ORACLE_CONFIG: GenericOracleConfig = {
  oracleName: "GenericOracle_LBTC_USDT",
  contractName: "FluidGenericOracle",
  infoName: "USDT per 1 LBTC",
  targetDecimals: 25,
  sources: [
    {
    ...
    },
    {
      ...
      invertRate: false,
      multiplier: BigNumber.from(10).pow(19), // scale BTC to e27 (+19), adjust USD to USDT (-2)
      divisor: 1e2,
    },
