...
const VAULT_QUEUE_COUNTER = 1; // #85
...
const ORACLE_CONFIG: GenericUniV3CheckedOracleConfig = {
  oracleName: "GenericUniV3CheckedOracle_WSTETH_SUSDS",
  contractName: "FluidGenericUniV3CheckedOracle",
  infoName: "SUSDS per 1 WSTETH",
  sources: [
    {
      sourceType: GenericOracleSourceType.Fluid,
      source: "0x2F95631D59F564D5e2dD0c028d4DAF3B876D84Fd", // WSTETH <> STETH contract rate
      invertRate: false,
    ...
    },
    {
      ...
      source: "0x86392dC19c0b719886221c78AB11eb8Cf5c52812", // STETH <> ETH
      invertRate: false,
      multiplier: BigNumber.from(10).pow(9), // scale token 0 STETH to 27
      divisor: 1,
    },
    {
