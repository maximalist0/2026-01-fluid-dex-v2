...
const VAULT_QUEUE_COUNTER = 5; // id 121
...
const ORACLE_CONFIG: GenericOracleConfig = {
  oracleName: "GenericOracle_PAXG_GHO",
  contractName: "FluidGenericOracle",
  infoName: "GHO per 1 PAXG",
  targetDecimals: 27, // scale PAXG 18 to 27 + GHO
  sources: [
    {
      sourceType: GenericOracleSourceType.Chainlink,
      source: "0x214eD9Da11D2fbe465a6fc601a91E62EbEc1a0D6", // XAU<>USD
      invertRate: false,
      multiplier: BigNumber.from(10).pow(19), // scale PAXG to e27 (+9), adjust USD to GHO (+10)
      divisor: 1,
    },
