...
const VAULT_QUEUE_COUNTER = 1; // id 117
...
const ORACLE_CONFIG: GenericOracleConfig = {
  ...
  targetDecimals: 27, // scale XAUT 6 to 27 + USDT
  sources: [
    {
      sourceType: GenericOracleSourceType.Chainlink,
      source: "0x214eD9Da11D2fbe465a6fc601a91E62EbEc1a0D6", // XAU<>USD
      invertRate: false,
      multiplier: BigNumber.from(10).pow(21), // scale XAUT to e27 (+21), adjust USD to USDT (-2)
      divisor: 1e2,
    },
