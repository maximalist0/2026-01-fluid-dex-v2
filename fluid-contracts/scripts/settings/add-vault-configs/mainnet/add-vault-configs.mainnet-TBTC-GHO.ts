...
const VAULT_QUEUE_COUNTER = 3; // id 90
...
const ORACLE_CONFIG: GenericOracleConfig = {
  oracleName: "GenericOracle_TBTC_GHO",
  contractName: "FluidGenericOracle",
  infoName: "GHO per 1 TBTC",
  sources: [
    {
      sourceType: GenericOracleSourceType.Chainlink,
      source: "0xF4030086522a5bEEa4988F8cA5B36dbC97BeE88c", // BTC<>USD
      invertRate: false,
      multiplier: BigNumber.from(10).pow(19), // assuming 1 BTC = 1 TBTC so scale 1 TBTC (18 decimals!!) to e27. but also scale USD to GHO (*1e10)
      divisor: 1,
    },
