...
const ORACLE_CONFIG: DexSmartDebtPegOracleConfig = {
  oracleName: "DexSmartDebtPegOracle_WEETH_USDC-USDT",
  contractName: "DexSmartDebtPegOracle",
  infoName: "USDC/USDT debtShares per 1 WEETH",
  ...
  colDebtOracle: "0x4AC043d5E9e4bB3d8D0DCaEA5a8aa5469D3C473E", // FallbackCLRSOracle_WEETH_USD
  colDebtInvert: false,
