...
const VAULT_QUEUE_COUNTER = 0; // id 136
...
const ORACLE_CONFIG: DexSmartColPegOracleConfig = {
  oracleName: "DexSmartColPegOracle_USDTB-USDE_USDTB",
  ...
  params: {
    ...
    infoName: "USDTB per 1 USDTB/USDE colShare",
    targetDecimals: 27,
    ...
    resultMultiplier: 1,
    resultDivisor: 1, // final quote go from USDE to USDTB
