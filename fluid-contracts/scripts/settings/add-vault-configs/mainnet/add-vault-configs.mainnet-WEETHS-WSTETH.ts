...
import { RESERVE_CONTRACT, WEETHS_ACCOUNTANT } from "../contract-addresses";
...
import { WeETHsWstETHOracleConfig } from "./add-vault-interfaces";
...
const SUPPLY_TOKEN = TOKENS_MAINNET.WEETHS.address;
const SUPPLY_DECIMALS = TOKENS_MAINNET.WEETHS.decimals; // count of decimals
...
const ORACLE_CONFIG: WeETHsWstETHOracleConfig = {
  oracleName: "WeETHsWstETHOracle_weETHs_wstETH",
  contractName: "WeETHsWstETHOracle",
  infoName: "wstETH for 1 weETHs",
  weETHs: TOKENS_MAINNET.WEETHS.address,
  weETHsAccountant: WEETHS_ACCOUNTANT,
