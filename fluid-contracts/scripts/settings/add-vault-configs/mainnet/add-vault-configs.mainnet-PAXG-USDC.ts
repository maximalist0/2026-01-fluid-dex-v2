...
const VAULT_QUEUE_COUNTER = 3; // id 119
...
const ORACLE_CONFIG: GenericOracleConfig = {
  oracleName: "GenericOracle_PAXG_USDC",
  contractName: "FluidGenericOracle",
  infoName: "USDC per 1 PAXG",
  targetDecimals: 15, // scale PAXG 18 to 27 + USDC
  sources: [
    {
      sourceType: GenericOracleSourceType.Chainlink,
      source: "0x214eD9Da11D2fbe465a6fc601a91E62EbEc1a0D6", // XAU<>USD
      invertRate: false,
      multiplier: BigNumber.from(10).pow(9), // scale PAXG to e27 (+9), adjust USD to USDC (-2)
      divisor: 1e2,
    },
