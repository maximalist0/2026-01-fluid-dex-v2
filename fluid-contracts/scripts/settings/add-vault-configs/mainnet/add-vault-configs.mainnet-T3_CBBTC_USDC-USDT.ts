...
const VAULT_QUEUE_COUNTER = 5;

const VAULTTYPE = VAULT_TYPE.T3_SMART_DEBT;

const SUPPLY_TOKEN = TOKENS_MAINNET.CBBTC.address;
const SUPPLY_DECIMALS = TOKENS_MAINNET.CBBTC.decimals; // count of decimals
...
const ORACLE_CONFIG: DexSmartDebtPegOracleConfig = {
  oracleName: "DexSmartDebtPegOracle_CBBTC_USDC-USDT",
  contractName: "DexSmartDebtPegOracle",
  infoName: "USDC/USDT debtShares per 1 CBBTC",
  ...
  colDebtOracle: "0x7D3069Bd52d34c71B125BF8942E246a5C39e62CE", // FallbackCLRSOracle_BTC_USD (not using CBBTC because 2% derivation threshold ATM)
  colDebtInvert: false,
