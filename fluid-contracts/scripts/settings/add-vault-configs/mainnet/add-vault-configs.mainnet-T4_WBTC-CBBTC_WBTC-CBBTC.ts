...
const BORROW_TOKEN = TOKENS_MAINNET.DEX_WBTC_CBBTC.address;
const BORROW_DECIMALS = TOKENS_MAINNET.DEX_WBTC_CBBTC.decimals; // count of decimals
...
const ORACLE_CONFIG: DexSmartT4PegOracleConfig = {
  oracleName: "DexSmartT4PegOracle_WBTC-CBBTC",
  contractName: "DexSmartT4PegOracle",
  infoName: "WBTC/CBBTC dbtSh. per 1 colSh.",
  params: {
