...
const VAULT_QUEUE_COUNTER = 0; // id 78

const VAULTTYPE = VAULT_TYPE.T2_SMART_COL;

const SUPPLY_TOKEN = TOKENS_MAINNET.DEX_RSETH_ETH.address;
const BORROW_TOKEN = TOKENS_MAINNET.WSTETH.address;

const ORACLE_CONFIG: DexSmartColPegOracleConfig = {
  oracleName: "DexSmartColPegOracle_RSETH-ETH_WSTETH",
  ...
  params: {
    ...
    reservesConversionParams: {
      reservesConversionOracle: "0xBeaEEa6ec8eE5bDfdaA4b4337bb9e120CE6a0330", // RSETH contract rate
