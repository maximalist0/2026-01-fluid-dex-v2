...
const VAULT_QUEUE_COUNTER = 8; // id 124
...
const ORACLE_CONFIG: DexSmartColPegOracleConfig = {
  oracleName: "DexSmartColPegOracle_PAXG-XAUT_GHO",
  contractName: "DexSmartColPegOracle",
  params: {
    dexPool: SUPPLY_TOKEN,
    quoteInToken0: false, // quote in XAUT
    targetDecimals: 27, // (18 decimals shares vs 18 decimals GHO so 27 - 0)
    infoName: "GHO per 1 PAXG/XAUT colShare",
    ...
    resultMultiplier: 1,
    resultDivisor: 1e12,
    colDebtOracle: "0x19Bb6BCEc763631d1faEef1ECf28c37B13963329", // GenericOracle_XAUT_GHO
    colDebtInvert: false,
  },
};
