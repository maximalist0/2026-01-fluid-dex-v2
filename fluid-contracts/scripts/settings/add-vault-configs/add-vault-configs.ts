...
const ORACLE_CONFIG: DexSmartColPegOracleConfig = {
  oracleName: "DexSmartColPegOracle_WBTC-CBBTC_USDC",
  contractName: "DexSmartColPegOracle",
  infoName: "USDC per 1 WBTC/CBBTC col share",
  ...
  colDebtOracle: "0x390421d1Fe8e238FFd9Ef86563CBF76F348CdD92", // FallbackCLRSOracle_CBBTC_USDC (uses BTC-USD-USDC)
  colDebtInvert: false,
