...
const VAULT_QUEUE_COUNTER = 2; // id 25
...
const ORACLE_CONFIG: GenericOracleConfig = {
  oracleName: "GenericOracle_POL_AUSD",
  contractName: "FluidGenericOracle",
  infoName: "AUSD per 1 POL",
  sources: [
    {
      ...
      invertRate: false,
      multiplier: BigNumber.from(10).pow(9), // scale POL to e27 (+9), adjust USD to AUSD (-2)
      divisor: 1e2,
    },
  ],
  targetDecimals: 15,
