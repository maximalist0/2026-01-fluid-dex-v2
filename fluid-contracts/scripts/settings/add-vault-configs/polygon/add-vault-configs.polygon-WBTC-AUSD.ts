  ...
  sources: [
    {
      ...
      invertRate: false,
      multiplier: BigNumber.from(10).pow(19), // scale WBTC to e27 (+19), adjust USD to AUSD (-2)
      divisor: 1e2,
    },
  ],
  targetDecimals: 25, // scale wbtc 8 to 27 + AUSD
};
