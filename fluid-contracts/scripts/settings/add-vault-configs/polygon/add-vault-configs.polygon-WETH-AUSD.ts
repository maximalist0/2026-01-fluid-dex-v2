...
const VAULT_QUEUE_COUNTER = 0; // id 23
...
const ORACLE_CONFIG: GenericOracleConfig = {
  oracleName: "GenericOracle_WETH_AUSD",
  contractName: "FluidGenericOracle",
  infoName: "AUSD per 1 WETH",
  sources: [
    {
      ...
      invertRate: false,
      multiplier: BigNumber.from(10).pow(9), // scale ETH to e27 (+9), adjust USD to AUSD (-2)
      divisor: 1e2,
    },
  ],
  targetDecimals: 15,
