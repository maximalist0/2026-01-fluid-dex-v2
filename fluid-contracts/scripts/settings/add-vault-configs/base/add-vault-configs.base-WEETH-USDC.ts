...
const SUPPLY_TOKEN = TOKENS_BASE.WEETH.address;
const SUPPLY_DECIMALS = TOKENS_BASE.WEETH.decimals; // count of decimals
...
const VAULT_CORE_SETTINGS: VaultCoreSettings = {
  ...
  collateralFactor: 75 * PERCENT_PRECISION,
  liquidationThreshold: 80 * PERCENT_PRECISION,
...
const VAULT_SUPPLY_CONFIG = (vault: string): AdminModuleStructs.UserSupplyConfigStruct => ({
  baseWithdrawalLimit: SUPPLY_DECIMALS_MULTIPLIER.mul(2_080), // 2_080 WEETH = ~7.5M USD @ 1WEETH = 3600
...
const ORACLE_CONFIG: FallbackCLRSOracleConfig = {
  oracleName: "FallbackCLRSOracleL2_WEETH_USDC",
  contractName: "FallbackCLRSOracleL2",
  infoName: "USDC for 1 WEETH",
  chainlinkParams: {
    hops: 3,
    feed1: {
      feed: "0xFC1415403EbB0c693f9a7844b92aD2Ff24775C65", // WEETH / ETH (market rate)
      invertRate: false,
      token0Decimals: 18,
