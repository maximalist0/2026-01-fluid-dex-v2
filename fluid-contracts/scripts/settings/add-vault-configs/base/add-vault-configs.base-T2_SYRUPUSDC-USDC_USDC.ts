...
const VAULT_QUEUE_COUNTER = 0; // id #36

const VAULTTYPE = VAULT_TYPE.T2_SMART_COL;

const SUPPLY_TOKEN = TOKENS_BASE.DEX_SYRUPUSDC_USDC.address;

const BORROW_TOKEN = TOKENS_BASE.USDC.address;

const ORACLE_CONFIG: DexSmartColPegOracleL2Config = {
  oracleName: "DexSmartColPegOracleL2_SYRUPUSDC-USDC_USDC",
  ...
  params: {
    ...
    reservesConversionParams: {
      reservesConversionOracle: "0x98612EE747EeDF29D1399C8D0a3ebb008EE6E7A5", // SYRUPUSDC capped rate
