...
const SUPPLY_DECIMALS = TOKENS_BASE.WSTETH.decimals; // count of decimals
...
const VAULT_CORE_SETTINGS: VaultCoreSettings = {
  ...
  liquidationPenalty: 4 * PERCENT_PRECISION,
  borrowFee: 0,
};
...
const VAULT_SUPPLY_CONFIG = (vault: string): AdminModuleStructs.UserSupplyConfigStruct => ({
  baseWithdrawalLimit: SUPPLY_DECIMALS_MULTIPLIER.mul(1_850), // 1_850 WSTETH = ~7.5M USD @ 1WSTETH = 4050
...
const ORACLE_CONFIG: FallbackCLRSOracleConfig = {
  oracleName: "FallbackCLRSOracleL2_WSTETH_USDC",
  contractName: "FallbackCLRSOracleL2",
  infoName: "USDC for 1 WSTETH",
  chainlinkParams: {
    hops: 3,
    feed1: {
      feed: "0x43a5C292A453A3bF3606fa856197f09D7B74251a", // WSTETH / ETH (market rate)
      invertRate: false,
      token0Decimals: 18,
