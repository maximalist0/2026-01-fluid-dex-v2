...
const BORROW_TOKEN = TOKENS_BASE.CBBTC.address;
const BORROW_DECIMALS = TOKENS_BASE.CBBTC.decimals; // count of decimals
...
const ORACLE_CONFIG: FallbackCLRSOracleConfig = {
  oracleName: "FallbackCLRSOracleL2_WEETH_CBBTC",
  contractName: "FallbackCLRSOracleL2",
  infoName: "CBBTC for 1 WEETH",
  chainlinkParams: {
    hops: 3,
    feed1: {
    ...
    feed3: {
      feed: "0x64c911996D3c6aC71f9b455B1E8E7266BcbD848F", // BTC / USD
      invertRate: true,
      token0Decimals: 8,
    } as ChainlinkStructs.ChainlinkFeedDataStruct,
