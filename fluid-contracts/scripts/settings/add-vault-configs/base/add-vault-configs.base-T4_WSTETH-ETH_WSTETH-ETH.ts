...
const SUPPLY_TOKEN = TOKENS_BASE.DEX_WSTETH_ETH.address;

const BORROW_TOKEN = TOKENS_BASE.DEX_WSTETH_ETH.address;
...
const ORACLE_CONFIG: DexSmartT4PegOracleL2Config = {
  ...
  params: {
    ...
    reservesConversionParams: {
      reservesConversionOracle: "0x674d013BDdeaC692e285B7988283dAB79590A698", // FluidCappedRate WSTETH
