...
const VAULT_QUEUE_COUNTER = 0; // id 35

const VAULTTYPE = VAULT_TYPE.T2_SMART_COL;

const SUPPLY_TOKEN = TOKENS_BASE.DEX_USDC_WSTUSR.address;

const BORROW_TOKEN = TOKENS_BASE.USDC.address;

const ORACLE_CONFIG: DexSmartColPegOracleL2Config = {
  oracleName: "DexSmartColPegOracleL2_USDC-WSTUSR_USDC",
  contractName: "DexSmartColPegOracleL2",
  params: {
    dexPool: SUPPLY_TOKEN,
    quoteInToken0: true, // quote in USDC
    infoName: "USDC per 1 USDC/WSTUSR colShare",
    targetDecimals: 15,
    pegBufferPercent: 5000, // 10000 = 1%; 100 = 0.01%
    reservesConversionParams: {
      reservesConversionOracle: "0x14288700Dc560a3F26a81FF10AB19C8b75846c2D", // WSTUSR capped rate
