...
const BORROW_TOKEN = TOKENS_BASE.EURC.address;
const BORROW_DECIMALS = TOKENS_BASE.EURC.decimals; // count of decimals
...
const ORACLE_CONFIG: FallbackCLRSOracleConfig = {
  oracleName: "FallbackCLRSOracleL2_CBETH_EURC",
  contractName: "FallbackCLRSOracleL2",
  infoName: "EURC for 1 CBETH",
  chainlinkParams: {
    hops: 2,
    feed1: {
    ...
    feed2: {
      feed: "0xDAe398520e2B67cd3f27aeF9Cf14D93D927f8250", // EURC / USD
      invertRate: true,
      token0Decimals: 6,
    } as ChainlinkStructs.ChainlinkFeedDataStruct,
    feed3: {
