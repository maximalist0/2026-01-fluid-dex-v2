...
const VAULT_QUEUE_COUNTER = 0; // # 21
...
const ORACLE_CONFIG: GenericOracleL2Config = {
  oracleName: "GenericOracleL2_LBTC_USDC",
  contractName: "FluidGenericOracleL2",
  infoName: "USDC per 1 LBTC",
  targetDecimals: 25, // scale LBTC 8 to 27 + USDC
  sources: [
    {
    ...
    },
    {
      ...
      invertRate: false,
      multiplier: BigNumber.from(10).pow(19), // scale BTC to e27 (+19), adjust USD to USDC (-2)
      divisor: 1e2,
    },
  ],
  // assume 1 USDC = 1 USD
