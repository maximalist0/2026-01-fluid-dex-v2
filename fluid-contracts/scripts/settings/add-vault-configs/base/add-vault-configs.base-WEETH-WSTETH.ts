...
const BORROW_DECIMALS = TOKENS_BASE.WSTETH.decimals; // count of decimals
...
const VAULT_BORROW_CONFIG = (vault: string): AdminModuleStructs.UserBorrowConfigStruct => ({
  baseDebtCeiling: BORROW_DECIMALS_MULTIPLIER.mul(1_850), // 1_850 WSTETH = ~7.5M USD @ 1WSTETH = 4050
  maxDebtCeiling: BORROW_DECIMALS_MULTIPLIER.mul(49_400), // 49_400 WSTETH = ~200M USD @ 1WSTETH = 4050
  expandDuration: 60 * 60 * 12, // 12hrs in seconds.
  expandPercent: 20 * PERCENT_PRECISION, // in 1e2
  mode: MODE_WITH_INTEREST, // with interest.
  //
...
const ORACLE_CONFIG: Ratio2xFallbackCLRSOracleL2Config = {
  ...
  cLRSParams1: {
    chainlinkParams: {
      hops: 1,
      feed1: {
        feed: "0x35e9D7001819Ea3B39Da906aE6b06A62cfe2c181", // WEETH <> eETH (contract exchange rate)
        invertRate: false,
  ...
  cLRSParams2: {
    chainlinkParams: {
      hops: 1,
      feed1: {
        feed: "0xB88BAc61a4Ca37C43a3725912B1f472c9A5bc061", // WSTETH <> STETH (contract exchange rate)
        invertRate: false,
        token0Decimals: 18,
      } as ChainlinkStructs.ChainlinkFeedDataStruct,
      feed2: {
