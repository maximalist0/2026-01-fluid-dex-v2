...
const VAULT_QUEUE_COUNTER = 0; // #39

const VAULTTYPE = VAULT_TYPE.T1;

const SUPPLY_TOKEN = TOKENS_BASE.SUSDE.address;
const BORROW_TOKEN = TOKENS_BASE.USDC.address;

const ORACLE_CONFIG: GenericOracleL2Config = {
  oracleName: "GenericOracleL2_SUSDE_USDC",
  contractName: "FluidGenericOracleL2",
  infoName: "USDC per 1 SUSDE",
  sources: [
    {
      sourceType: GenericOracleSourceType.Fluid,
      source: "0xf87135DF7E10196CccCF589D6534394461b62C79", // FluidCappedRate SUSDE
      invertRate: false,
      multiplier: 1,
      divisor: 1e12,
    },
