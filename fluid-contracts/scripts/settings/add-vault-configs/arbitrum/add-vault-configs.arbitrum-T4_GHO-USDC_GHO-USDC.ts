...
const SUPPLY_TOKEN = TOKENS_ARBITRUM.DEX_GHO_USDC.address;

const BORROW_TOKEN = TOKENS_ARBITRUM.DEX_GHO_USDC.address;

const ORACLE_CONFIG: DexSmartT4PegOracleL2Config = {
  oracleName: "DexSmartT4PegOracleL2_GHO-USDC",
