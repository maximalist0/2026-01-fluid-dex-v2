...
const BORROW_TOKEN = TOKENS_ARBITRUM.ARB.address;
const BORROW_DECIMALS = TOKENS_ARBITRUM.ARB.decimals; // count of decimals
...
const VAULT_BORROW_CONFIG = (vault: string): AdminModuleStructs.UserBorrowConfigStruct => ({
  baseDebtCeiling: BORROW_DECIMALS_MULTIPLIER.mul(12_500_000), // 12_500_000 ARB = ~7.5M USD @ 1ARB = 0.60
  maxDebtCeiling: BORROW_DECIMALS_MULTIPLIER.mul(333_333_333), // 333_333_333 ARB = ~200M USD @ 1ARB = 0.60
  expandDuration: 60 * 60 * 12, // 12hrs in seconds.
  expandPercent: 20 * PERCENT_PRECISION, // in 1e2
  mode: MODE_WITH_INTEREST, // with interest.
  //
...
const ORACLE_CONFIG: FallbackCLRSOracleConfig = {
  oracleName: "FallbackCLRSOracleL2_ETH_ARB",
  contractName: "FallbackCLRSOracleL2",
  infoName: "ARB for 1 ETH",
  chainlinkParams: {
    hops: 2,
    feed1: {
