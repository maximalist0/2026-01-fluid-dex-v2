...
const VAULT_QUEUE_COUNTER = 0; // id #48
...
const ORACLE_CONFIG: DexSmartColPegOracleL2Config = {
  oracleName: "DexSmartColPegOracleL2_WSTUSR-USDC_USDC",
  ...
  params: {
    ...
    reservesConversionParams: {
      reservesConversionOracle: "0xd86F76B2DCcb74090dF88F89a6A27407041DF425", // WSTUSR capped rate
