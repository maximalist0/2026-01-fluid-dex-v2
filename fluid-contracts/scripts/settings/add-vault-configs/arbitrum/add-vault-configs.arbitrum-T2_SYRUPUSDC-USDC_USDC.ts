...
const VAULT_QUEUE_COUNTER = 0; // id #50

const VAULTTYPE = VAULT_TYPE.T2_SMART_COL;

const SUPPLY_TOKEN = TOKENS_ARBITRUM.DEX_SYRUPUSDC_USDC.address;
...
const ORACLE_CONFIG: DexSmartColPegOracleL2Config = {
  ...
  params: {
    ...
    reservesConversionParams: {
      reservesConversionOracle: "0x4818676467Cc95b6279ff68BC416877227380ad4", // SYRUPUSDC capped rate
