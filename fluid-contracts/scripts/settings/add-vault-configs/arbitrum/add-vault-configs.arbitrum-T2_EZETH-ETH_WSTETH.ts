...
const VAULT_QUEUE_COUNTER = 0; // id 63

const VAULTTYPE = VAULT_TYPE.T2_SMART_COL;

const SUPPLY_TOKEN = TOKENS_ARBITRUM.DEX_EZETH_ETH.address;
...
const ORACLE_CONFIG: DexSmartColPegOracleL2Config = {
  ...
  params: {
    ...
    reservesConversionParams: {
      reservesConversionOracle: "0x9BC84B6054e5B7ae821Abe497FfBaa452C49D88f", // FluidCappedRate EZETH
