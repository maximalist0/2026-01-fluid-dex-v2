...
const VAULT_QUEUE_COUNTER = 7; // id #61
...
const ORACLE_CONFIG: DexSmartDebtPegOracleConfig = {
  ...
  params: {
    ...
    resultDivisor: 1,
    colDebtOracle: "0xbCBC81E9339056a78BfD11D934F7B33b371eDD17", // DexSmartColPegOracleL2_SUSDE-USDT_USDT "USDT per 1 SUSDE/USDT colSh.",
    colDebtInvert: false,
  },
};
