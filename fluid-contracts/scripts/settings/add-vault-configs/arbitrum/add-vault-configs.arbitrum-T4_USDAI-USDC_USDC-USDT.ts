...
const ORACLE_CONFIG: DexSmartDebtPegOracleConfig = {
  ...
  params: {
    ...
    infoName: "USDC-T dbtSh /1 USDAI-USDC colSh",
    ...
    resultMultiplier: 1,
    resultDivisor: 1,
    colDebtOracle: "0x3a16e2DeFa8c0973ED9933eD35244bcb28b85D26", // DexSmartColPegOracleL2_USDAI-USDC_GHO "GHO per 1 USDAI/USDC colSh."
    colDebtInvert: false,
  },
};
