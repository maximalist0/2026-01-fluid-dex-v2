...
const VAULT_QUEUE_COUNTER = 0; // id 16

const VAULTTYPE = VAULT_TYPE.T4_SMART_COL_SMART_DEBT;

const SUPPLY_TOKEN = TOKENS_ARBITRUM.DEX_WSTETH_ETH.address;

const BORROW_TOKEN = TOKENS_ARBITRUM.DEX_WSTETH_ETH.address;

const ORACLE_CONFIG: DexSmartT4PegOracleL2Config = {
  oracleName: "DexSmartT4PegOracleL2_WSTETH-ETH",
  ...
  params: {
    ...
    reservesConversionParams: {
      reservesConversionOracle: "0x4BD81CE5dEF773ee766C7D931b7477093f6C9677", // ChainlinkCenterPriceL2_WSTETH_ETH
