...
const VAULT_QUEUE_COUNTER = 1; // # 32
...
const ORACLE_CONFIG: GenericOracleL2Config = {
  oracleName: "GenericOracleL2_WSTETH_GHO",
  contractName: "FluidGenericOracleL2",
  infoName: "GHO per 1 WSTETH",
  targetDecimals: 27, // scale WSTETH 18 to 27 + GHO
  sources: [
    {
      sourceType: GenericOracleSourceType.Chainlink,
      source: "0xb523AE262D20A936BC152e6023996e46FDC2A95D", // WSTETH / ETH (market rate)
      invertRate: false,
    ...
    },
    {
      ...
      invertRate: false,
      multiplier: BigNumber.from(10).pow(19), // scale ETH to e27 (+9), and from USD to GHO (+10)
      divisor: 1,
    },
  ],
  // assume 1 GHO = 1 USD
