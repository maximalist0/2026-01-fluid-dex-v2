...
const VAULT_QUEUE_COUNTER = 6; // id #60

const VAULTTYPE = VAULT_TYPE.T2_SMART_COL;

const SUPPLY_TOKEN = TOKENS_ARBITRUM.DEX_SUSDE_USDT.address;

const BORROW_TOKEN = TOKENS_ARBITRUM.USDT.address;

const ORACLE_CONFIG: DexSmartColPegOracleL2Config = {
  oracleName: "DexSmartColPegOracleL2_SUSDE-USDT_USDT",
  contractName: "DexSmartColPegOracleL2",
  params: {
    dexPool: SUPPLY_TOKEN,
    quoteInToken0: false, // quote in USDT
    infoName: "USDT per 1 SUSDE/USDT colSh.",
    targetDecimals: 15,
    pegBufferPercent: 1000, // 10000 = 1%; 100 = 0.01%
    reservesConversionParams: {
      reservesConversionOracle: "0x4025254661A2e8DCE7F86836aaeEEA72277968D4", // SUSDE capped rate
