...
const VAULT_CORE_SETTINGS: VaultCoreSettings = {
  ...
  liquidationMaxLimit: 93 * PERCENT_PRECISION,
  withdrawGap: 5 * PERCENT_PRECISION,
  liquidationPenalty: 1 * PERCENT_PRECISION,
  borrowFee: 0,
};
...
const VAULT_SUPPLY_CONFIG = (vault: string): AdminModuleStructs.UserSupplyConfigStruct => ({
  baseWithdrawalLimit: SUPPLY_DECIMALS_MULTIPLIER.mul(2_630), // 2_630 ETH = ~7.5M USD @ 1ETH = 2850
...
const ORACLE_CONFIG: UniV3CheckCLRSOracleConfig = {
  oracleName: "UniV3CheckCLRSOracleL2_ETH_USDC",
  contractName: "UniV3CheckCLRSOracleL2",
  infoName: "USDC for 1 ETH",
  params: {
    chainlinkParams: {
      hops: 2,
      feed1: {
    ...
    uniV3Params: {
      pool: "0xC6962004f452bE9203591991D15f6b388e09E8D0", // ETH <> USDC
