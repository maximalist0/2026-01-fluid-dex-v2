...
const VAULT_QUEUE_COUNTER = 1; // id 17

const VAULTTYPE = VAULT_TYPE.T2_SMART_COL;

const SUPPLY_TOKEN = TOKENS_ARBITRUM.DEX_WEETH_ETH.address;
...
const ORACLE_CONFIG: DexSmartColPegOracleL2Config = {
  ...
  params: {
    ...
    reservesConversionParams: {
      reservesConversionOracle: "0x71E1E7b2561a3F8edcC22C7B3446E0b01E062d37", // ChainlinkCenterPriceL2_WEETH_ETH
