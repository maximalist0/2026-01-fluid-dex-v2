...
const VAULT_QUEUE_COUNTER = 5; // id #42
...
const ORACLE_CONFIG: DexSmartColPegOracleL2Config = {
  oracleName: "DexSmartColPegOracleL2_USDAI-USDC_USDT",
  contractName: "DexSmartColPegOracleL2",
  params: {
    dexPool: SUPPLY_TOKEN,
    quoteInToken0: true, // quote in USDAI
    infoName: "USDT per 1 USDAI/USDC colSh.",
    targetDecimals: 15,
