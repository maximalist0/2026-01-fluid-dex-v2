...
const TOKEN = TOKENS_PLASMA.WETH.address;
const DECIMALS = TOKENS_PLASMA.WETH.decimals; // count of decimals
...
const LIQUIDITY_RATE_DATA: AdminModuleStructs.RateDataV1ParamsStruct | AdminModuleStructs.RateDataV2ParamsStruct = {
  ...
  rateAtUtilizationKink1: 3 * PERCENT_PRECISION,
...
const FTOKEN_SUPPLY_CONFIG = (fTokenAddress: string): AdminModuleStructs.UserSupplyConfigStruct => ({
  ...
  baseWithdrawalLimit: DECIMALS_MULTIPLIER.mul(1_660), // = ~7.5M USD @ 1ETH = ~4520
