...
const TOKEN = TOKENS_PLASMA.USDE.address;
const DECIMALS = TOKENS_PLASMA.USDE.decimals; // count of decimals
...
const FTOKEN_SUPPLY_CONFIG = (fTokenAddress: string): AdminModuleStructs.UserSupplyConfigStruct => ({
  ...
  baseWithdrawalLimit: DECIMALS_MULTIPLIER.mul(7_500_000), // 7.5M USDE
