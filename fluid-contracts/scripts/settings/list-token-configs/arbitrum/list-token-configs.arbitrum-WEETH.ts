...
const TOKEN = TOKENS_ARBITRUM.WEETH.address;
const DECIMALS = TOKENS_ARBITRUM.WEETH.decimals; // count of decimals
...
const FTOKEN_SUPPLY_CONFIG = (fTokenAddress: string): AdminModuleStructs.UserSupplyConfigStruct => ({
  ...
  baseWithdrawalLimit: DECIMALS_MULTIPLIER.mul(2_250), // 2_250 WEETH = ~7.5M USD @ 1WEETH = 3325
