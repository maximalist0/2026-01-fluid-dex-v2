...
const TOKEN = TOKENS_ARBITRUM.USDC.address;
const DECIMALS = TOKENS_ARBITRUM.USDC.decimals; // count of decimals
...
const LENDING_REWARDS_RATE_MODEL = {
  ...
  rewardAmount: DECIMALS_MULTIPLIER.mul(300_000), // 100k / month
  startTime: Math.floor(Date.now() / 1000) + 86400 * 2, // current time in seconds + 2 days
  configurator: AVOCADO_TEAM_MULTISIG,
  fToken1: "0x1A996cb54bb95462040408C06122D45D6Cdb6096", // fUSDC
  fToken2: "0x4A03F37e7d3fC243e3f99341d36f4b829BEe5E03", // fUSDT
  fToken3: "",
};
