...
const TOKEN = TOKENS_ARBITRUM.WSTETH.address;
const DECIMALS = TOKENS_ARBITRUM.WSTETH.decimals; // count of decimals
...
const FTOKEN_SUPPLY_CONFIG = (fTokenAddress: string): AdminModuleStructs.UserSupplyConfigStruct => ({
  ...
  baseWithdrawalLimit: DECIMALS_MULTIPLIER.mul(2_000), // 2_000 WSTETH = ~7.5M USD @ 1WSTETH = 3750
