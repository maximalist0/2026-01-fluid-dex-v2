...
const TOKEN = TOKENS_ARBITRUM.ARB.address;
const DECIMALS = TOKENS_ARBITRUM.ARB.decimals; // count of decimals
...
const FTOKEN_SUPPLY_CONFIG = (fTokenAddress: string): AdminModuleStructs.UserSupplyConfigStruct => ({
  ...
  baseWithdrawalLimit: DECIMALS_MULTIPLIER.mul(10_260_000), // 10_260_000 ARB = ~7.5M USD @ 1ARB = 0.73
