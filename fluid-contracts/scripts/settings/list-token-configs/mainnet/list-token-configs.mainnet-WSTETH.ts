...
const TOKEN = TOKENS_MAINNET.WSTETH.address; // WSTETH on Mainnet
const DECIMALS = TOKENS_MAINNET.WSTETH.decimals; // count of decimals
...
const LIQUIDITY_RATE_DATA: AdminModuleStructs.RateDataV1ParamsStruct | AdminModuleStructs.RateDataV2ParamsStruct = {
  ...
  rateAtUtilizationKink1: 1 * PERCENT_PRECISION,
  rateAtUtilizationKink2: 4 * PERCENT_PRECISION,
