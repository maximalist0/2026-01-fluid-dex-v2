...
const TOKEN = TOKENS_MAINNET.USDT.address; // USDT on Mainnet
const DECIMALS = TOKENS_MAINNET.USDT.decimals; // count of decimals
...
const LENDING_REWARDS_RATE_MODEL = {
  duration: 60 * 60 * 24 * 90, // 90 days (new 90 days switching at ~ Dec 20)
  startTvl: DECIMALS_MULTIPLIER.mul(1_000), // start at 1000 USDT
  rewardAmount: DECIMALS_MULTIPLIER.mul(1_500_000), // 1_500_000 USDT for 90 days
  initiator: constants.AddressZero,
  previousModel: "0x19147A180D271d90dC12Da2BFFC636F54Cf7C241",
};
