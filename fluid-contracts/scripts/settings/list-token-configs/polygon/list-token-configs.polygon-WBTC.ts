...
const TOKEN = TOKENS_POLYGON.WBTC.address;
...
const LIQUIDITY_RATE_DATA: AdminModuleStructs.RateDataV1ParamsStruct | AdminModuleStructs.RateDataV2ParamsStruct = {
  ...
  rateAtUtilizationKink1: Math.round(3.1 * PERCENT_PRECISION),
  rateAtUtilizationKink2: Math.round(10.2 * PERCENT_PRECISION),
