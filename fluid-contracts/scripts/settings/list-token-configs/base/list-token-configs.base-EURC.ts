...
const TOKEN = TOKENS_BASE.EURC.address;
const DECIMALS = TOKENS_BASE.EURC.decimals; // count of decimals
...
const LIQUIDITY_RATE_DATA: AdminModuleStructs.RateDataV1ParamsStruct | AdminModuleStructs.RateDataV2ParamsStruct = {
  ...
  rateAtUtilizationKink2: 10 * PERCENT_PRECISION,
...
const FTOKEN_SUPPLY_CONFIG = (fTokenAddress: string): AdminModuleStructs.UserSupplyConfigStruct => ({
  ...
  baseWithdrawalLimit: DECIMALS_MULTIPLIER.mul(7_500_000), // 7.5M EURC
...
const LENDING_REWARDS_RATE_MODEL = {
  ...
  startTvl: DECIMALS_MULTIPLIER.mul(1_000), // start at 1000 EURC
  rewardAmount: DECIMALS_MULTIPLIER.mul(30_000), // 30_000 EURC for 90 days
  startTime: Math.floor(Date.now() / 1000) + 86400 / 2, // current time in seconds + 1/2 day
  configurator: AVOCADO_TEAM_MULTISIG,
  fToken1: "0x1943FA26360f038230442525Cf1B9125b5DCB401", // fEURC
  fToken2: "",
  fToken3: "",
};
