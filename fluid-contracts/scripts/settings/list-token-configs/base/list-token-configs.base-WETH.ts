...
const TOKEN = TOKENS_BASE.WETH.address;
const DECIMALS = TOKENS_BASE.WETH.decimals; // count of decimals
...
const FTOKEN_SUPPLY_CONFIG = (fTokenAddress: string): AdminModuleStructs.UserSupplyConfigStruct => ({
  ...
  baseWithdrawalLimit: DECIMALS_MULTIPLIER.mul(2_180), // 2_180 ETH = ~7.5M USD @ 1ETH = 3450
