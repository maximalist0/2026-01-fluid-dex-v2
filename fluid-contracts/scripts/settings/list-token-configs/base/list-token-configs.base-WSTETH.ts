...
const TOKEN = TOKENS_BASE.WSTETH.address;
const DECIMALS = TOKENS_BASE.WSTETH.decimals; // count of decimals
...
const FTOKEN_SUPPLY_CONFIG = (fTokenAddress: string): AdminModuleStructs.UserSupplyConfigStruct => ({
  ...
  baseWithdrawalLimit: DECIMALS_MULTIPLIER.mul(1_850), // 1_850 WSTETH = ~7.5M USD @ 1WSTETH = 4050
