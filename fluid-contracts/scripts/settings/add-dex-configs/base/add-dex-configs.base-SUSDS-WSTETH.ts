...
const TOKEN0 = TOKENS_BASE.SUSDS.address;
const TOKEN1 = TOKENS_BASE.WSTETH.address;

const ORACLE_MAPPING = 1024; // should be 6144 on Base (2s) to be consistent ~1 day everywhere
