...
const TOKEN0 = TOKENS_BASE.SYRUPUSDC.address;
const TOKEN1 = TOKENS_BASE.USDC.address;
const ORACLE_MAPPING = 6144; // should be 6144 on Base (2s) to be consistent ~1 day everywhere
