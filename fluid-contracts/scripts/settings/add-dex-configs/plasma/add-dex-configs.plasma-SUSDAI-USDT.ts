...
const TOKEN0 = TOKENS_PLASMA.SUSDAI;
...
const DEX_SUPPLY_TOKEN0_CONFIG = (dexT1: string): AdminModuleStructs.UserSupplyConfigStruct => ({
  baseWithdrawalLimit: TOKEN0_DECIMALS_MULTIPLIER.mul(4_750_000), // = ~5M USD
...
const DEX_INIT_SETTINGS: DexAdminModuleStructs.InitializeVariablesStruct = {
  ...
  smartDebt: false,
  token0DebtAmt: 0,
  centerPrice: "1033276566891630224000000000",
  fee: 1e4 * 0.01,
  revenueCut: 1e4 * 25,
